  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity onPress={order_details.bind(this,item.id)} style={{ borderWidth:1, borderRadius:10, borderColor:colors.light_grey, marginBottom:20}} activeOpacity={1}>
      <DropShadow
        ...
        >
          <View style={{ flexDirection:'row', backgroundColor:colors.light_grey, padding:10}}>
            <View style={{ width:'20%'}}>
          ...
          <View style={{ flexDirection:'row', backgroundColor:colors.theme_bg_three, padding:10 }}>
